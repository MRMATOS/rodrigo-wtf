const pt = {
  ...
  tools: {
    ...
    tool1: {
      ...
      description: "Waze para pedestres antissociais e inquilinos exigentes. Descubra quais ruas têm cachorros que latem, bares barulhentos ou paz absoluta, antes de caminhar ou alugar.",
      status: "Beta Aberto",
